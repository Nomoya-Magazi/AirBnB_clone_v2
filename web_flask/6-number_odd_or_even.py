...
@app.route("/number_template/(any integer)", strict_slashes=False)
def template(n):
    """/number_template/(any integer)
    Args:
        n (int): (any integer)
    Returns:
...
@app.route("/airbnb-dynamic/number_odd_or_even/(any integer)", strict_slashes=False)
def odd_or_even(n):
